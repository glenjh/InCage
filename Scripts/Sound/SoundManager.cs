...
public class SoundManager : MonoBehaviour
{
    ...
    public void PlaySound3D(string clipName, Transform audioTarget, float delay = 0f, bool isLoop = false, SoundType type = SoundType.EFFECT, bool attachToTarget = false, float minDistance = 0.0f, float maxDistance = 30.0f)
    {
